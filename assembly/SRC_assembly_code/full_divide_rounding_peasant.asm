...
mult:	andi	r7,r4,1		;is odd?
	brzr	r24,r7
	add	r2,r2,r0		;it is odd, add to sum
even:	shr	r4,r4,1		;interger half number
	shl	r0,r0,1		;double number
	brnz	r31,r4		;if number is not zero we are not done yet
